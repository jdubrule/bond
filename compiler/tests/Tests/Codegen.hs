...
verifyApplyCodegen args baseName =
  ...
  where
    ...
    protocols =
        [ ProtocolReader "bond::CompactBinaryReader<bond::InputBuffer>" "BOND_COMPACT_BINARY_PROTOCOL"
        , ProtocolWriter "bond::CompactBinaryWriter<bond::OutputBuffer>" "BOND_COMPACT_BINARY_PROTOCOL"
        , ProtocolWriter "bond::CompactBinaryWriter<bond::OutputCounter>" "BOND_COMPACT_BINARY_PROTOCOL"
        , ProtocolReader "bond::FastBinaryReader<bond::InputBuffer>" "BOND_FAST_BINARY_PROTOCOL"
        , ProtocolWriter "bond::FastBinaryWriter<bond::OutputBuffer>" "BOND_FAST_BINARY_PROTOCOL"
        , ProtocolReader "bond::SimpleBinaryReader<bond::InputBuffer>" "BOND_SIMPLE_BINARY_PROTOCOL"
        , ProtocolWriter "bond::SimpleBinaryWriter<bond::OutputBuffer>" "BOND_SIMPLE_BINARY_PROTOCOL"
        ]
